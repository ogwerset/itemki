# Convert CSV to JSON with proper structure
import json
...
inventory_data = {
    "items": [
        ...
        {"serial": "DOM006", "item": "Maszyna do dymu", "box": "BOX05", "lastSeen": "2025-09-14 21:35:09", "boxChanged": "2025-09-14 21:35:17"},
        {"serial": "DOM014", "item": "Wytłoczka do ciasteczek", "box": "BOX05", "lastSeen": "2025-09-14 21:35:25", "boxChanged": "2025-09-14 21:35:31"},
        {"serial": "DOM037", "item": "Zestaw alkoholowy - limoncelo", "box": "BOX05", "lastSeen": "2025-09-14 21:35:40", "boxChanged": "2025-09-14 21:35:47"},
        {"serial": "DOM071", "item": "Pudełko po butach - czerwone", "box": "TIDAL", "lastSeen": "2025-09-15 12:30:00", "boxChanged": "2025-09-15 12:30:15"},
        # Add more items here
    ],
    "boxes": [
        {"code": "BOX05", "name": "Pudełko różne", "location": "Magazyn", "itemCount": 14},
        {"code": "TIDAL", "name": "Studio Tidal", "location": "Studio", "itemCount": 1},
    ]
}
...
print(f"Created data.json with {len(inventory_data['items'])} items and {len(inventory_data['boxes'])} boxes")